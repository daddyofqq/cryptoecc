#! /usr/bin/env python3
# this file is copied from RFC8032, for testing ed448/ed25519
...
if __name__ == "__main__":
    d = bytearray.fromhex("c4eab05d357007c632f3dbb48489924d 552b08fe0c353a0d4a1f00acda2c463afbea67c5e8d2877c5e3bc397a659949ef8021e954e0a12274e")
    pk = bytearray.fromhex("43ba28f430cdff456ae531545f7ecd0ac834a55d9358c0372bfa0c6c6798c0866aea01eb00742802b8438ea4cb82169c235160627b4c3a9480")
    m = bytearray.fromhex("03");
    ctx = bytearray.fromhex("666f6f")
    ss = bytearray.fromhex("d4f8f6131770dd46f40867d6fd5d5055de43541f8c5e35abbcd001b32a89f7d2151f7647f11d8ca2ae279fb842d607217fce6e042f6815ea000c85741de5c8da1144a6a1aba7f96de42505d7a7298524fda538fccbbb754f578c1cad10d54d0d5428407e85dcbc98a49155c13764e66c3c00")

    sig = Ed448.sign(d, pk, m, ctx)

    print("generated sig {}", sig.hex())
    print("expected sig {}", ss.hex())
